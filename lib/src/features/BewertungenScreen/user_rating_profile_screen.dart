...
import 'package:meetkoch/src/features/BewertungenScreen/rating_screen.dart';
                ...
                children: [
                  ...
                  FutureBuilder<double>(
                    ...
                    builder: (context, ratingSnapshot) {
                      ...
                      final r = ratingSnapshot.data ?? 0.0;
                      return Column(
                        children: [
                          _buildStars(r),
                          const SizedBox(height: 5),
                          Text('${r.toStringAsFixed(1)} Sterne',
                              style: const TextStyle(
                  ...
                  const Text('Vergangene Bewertungen:',
                      style: TextStyle(
                          fontSize: 20,
                          fontWeight: FontWeight.bold,
                          color: Colors.white)),
                  ...
                  FutureBuilder<List<Map<String, dynamic>>>(
                    ...
                    builder: (context, reviewsSnapshot) {
                      if (reviewsSnapshot.connectionState ==
                        ...
                        return const Text('Keine Bewertungen verfügbar.',
